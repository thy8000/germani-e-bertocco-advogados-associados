...
function it9_create_about_us_content_fields()
{
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'field_6522dddca0e5e',
                'label' => 'Imagem Destacada',
                'name' => 'about_us_feature_featured_image',
                'aria-label' => '',
                'type' => 'image',
                'instructions' => '',
                'required' => 1,
            ...
            array(
                'key' => 'field_6522ddf3a0e5f',
                'label' => 'Título Maior',
                'name' => 'about_us_feature_big_title',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 1,
            ...
            array(
                'key' => 'field_6522de09a0e60',
                'label' => 'Título Menor',
                'name' => 'about_us_feature_small_title',
                'aria-label' => '',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 1,
            ...
            array(
                'key' => 'field_6522de12a0e61',
                'label' => 'Lista de Vantagens',
                'name' => 'about_us_feature_features_list',
                'aria-label' => '',
                'type' => 'repeater',
                'instructions' => '',
                'required' => 1,
                ...
                'sub_fields' => array(
                    array(
                        ...
                        'placeholder' => '',
                        'new_lines' => '',
                        'parent_repeater' => 'field_6522de12a0e61',
                    ),
                    array(
                        'key' => 'field_6522de5aa0e63',
                        'label' => 'Título Menor',
                        'name' => 'small_title',
                        'aria-label' => '',
                        'type' => 'textarea',
